...
### E. Next approved slice + constraint (21AB)

- **Next:** **Slice 21AB** — **authenticated** **CJ** shipping-calculator proof for **6** shortlisted candidates, **without** Shopify app **install**.
- **Constraint:** **CJ** **login** may be used **only** to capture **shipping calculator** proof. **Shopify** app **install**, **Shopify authorization**, **import/sync**, **Shopify** **Admin** edits, and **product staging** **remain BLOCKED**.
...
- **Version:** 1.17  
- **Next review:** **Product Owner / User** + **Product Manager** — **Slice 21AB** — **CJdropshipping** **authenticated** shipping-calculator proof for **6** shortlisted candidates **without** Shopify app **install** (**CJ** **login** **only** for calculator evidence — **no** **Shopify** app **install**, **no** **Shopify authorization**, **no** import/sync, **no** **Admin** edits, **no** staging; **DSers** **second**; **hybrid** conditional; **Gadgetgyz** **closed** **current** pilot; **Temu** benchmark-only; **no** **`Supplier verified`**, **no** checkout/payment/customer-access/public launch, **no** **final** pricing/delivery/claims). **Slice 21AA** recorded as **INCONCLUSIVE / BLOCKED** on public **ZA** calculator (**§15I**). **DevOps / Platform Engineer** — **no** install/import/sync. **Product Owner / User** — maintains **customer access BLOCKED** and all headline gates. **Product Manager** or **Senior Full-Stack Software Architect** — maintain **§15A** / **§15C** / **§15D** / **§15E** / **§15F** / **§15G** / **§15H** / **§15I** as living planning records. **Canonical:** **`docs/project-control.md` `## Slice 21X`** + **`## Slice 21Y`** + **`## Slice 21Z`** + **`## Slice 21AA`** + **`## Slice 21AB`** + **`docs/catalogue/mzansi-select-25-product-readiness-v1.md` `## Slice 21X`** + **`## Slice 21Z`** + **`## Slice 21AA`** + **`docs/catalogue/local-supplier-sourcing-matrix-v1.md` `## Slice 21X`** + **`## Slice 21Y`** + **`## Slice 21Z`** + **`## Slice 21AA`**.
