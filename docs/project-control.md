...
- Active slice: **QA / Test Engineer** — rendered decorative-image validation on preview theme **`151207542967`** post-**Slice 21CO** (homepage hero/category/promo/tiles/static fallbacks at **`1366x768`** + **`390x844`**; confirm broken-image blocker closed).
...
- **No preview push** in this slice.
- **Next owner:** **DevOps / Platform Engineer** — bounded **`--only`** push: decorative JPGs, placeholder SVG, touched sections/snippets/CSS to **`151207542967`**.
