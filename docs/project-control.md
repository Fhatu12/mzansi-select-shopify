...
- Active owner: **Product Owner / User** — resolve the blocked execution decisions for the CJ 3-SKU route before any later Admin slice is attempted; **customer access remains BLOCKED**. **DevOps / Platform Engineer** — blocked manual staging attempt recorded with no Admin changes. **Senior Full-Stack Software Architect** — prior planning artifact remains on record. **Security / Compliance Engineer** — **Slice 21AC** **PASS WITH NOTES** retained — **`## Slice 21AC`** / **§15K**. **Product Manager** — maintain **CJ** **long**-**delivery** **imported**-**route** discipline (**not** **local**/**fast** replacement framing).
- Next owner: **Product Owner / User** — decide the missing exact field values or keep the route blocked. **Product Manager** — support exact staging-price, landed-cost, and claim/delivery-risk interpretation if the route is reopened. **DevOps / Platform Engineer** — **no** app install, **no** import/sync, **no** **Admin**/**staging**, **no** **`Mzansi Select Controlled Pilot — Gadgetgyz`** cleanup until explicit later slices. **Do not** commit **`zadropshipping/`** or **`artifacts/`**.
- Last accepted slice: **Slice 21AD** — **CJ** **3**-**SKU** **imported**-**supplier** **controlled**-**pilot** **manual Shopify staging execution attempt** — **BLOCKED** — **DevOps / Platform Engineer** stopped before Admin changes because exact staged field values were missing. **Prior:** **Slice 21AD** planning artifact; **Slice 21AC**; **Slice 21AB**; **Slice 21AA**; **Slice 21Z**; **Slice 21Y**; **Slice 21X**; **Slice 21W-B**; **Slice 21V**; **Slice 21U**; **Slice 21T**; **Slice 21S** — **`3d1511b`**; **Slice 21R**; **Slice 21Q-B3**; **Slice 21O**; **Slice 21N** — **`417e78f5ec37ab8d9e450a8fd7d9aab9c10025fd`**; **Slice 21M** / **21L** / **21K** / **21J**; **Slice 19B PASS** and earlier tracker chain unchanged.
...
- Last tracker update: **Slice 21AD** — **CJ** **3**-**SKU** **imported**-**supplier** **controlled**-**pilot** **manual Shopify staging execution attempt** — **BLOCKED** — **DevOps / Platform Engineer** stopped before Admin changes because the accepted plan did not contain exact staged field values for the three approved SKUs (`docs: record cj manual product staging` — see **`git log -1`** after commit). **Posture:** route remains blocked for execution; customer access remains **BLOCKED**; **no** **CJ** app install, **no** Shopify authorization, **no** import/sync, **no** Shopify Admin edit, **no** product staging, **no** theme publish, **no** checkout/payment/customer-access action. **Next:** **Product Owner / User** resolve the missing field decisions or keep the route blocked.
- Tracker status: **Slice 21AD BLOCKED** + **Slice 21AD PASS WITH NOTES** (planning artifact) + **Slice 21AC PASS WITH NOTES** + **Slice 21AB PASS WITH NOTES** + **Slice 21AA INCONCLUSIVE / BLOCKED** (**ZA** shipping calculator at public desk) + **Slice 21Z PASS WITH NOTES** + **Slice 21Y PASS WITH NOTES** + **Slice 21X PASS WITH NOTES** + **Slice 21W-B INCONCLUSIVE / BLOCKED** + **Slice 21V PASS WITH NOTES / CONDITIONAL** + **Slice 21U PASS WITH NOTES** + **Slice 21T PASS WITH NOTES** + **Slice 21S PASS WITH NOTES** + **Slice 21R PASS WITH NOTES** + **Slice 21Q-B3 PASS WITH NOTES** + **Slice 21Q-B1** + **Slice 21P** + **Slice 21O PASS WITH NOTES** + **Slice 21N PASS WITH NOTES** + **Slice 21M** + **Slice 21L** + **Slice 21K** + **Slice 21J PASS WITH NOTES** + **Slice 19B PASS** + **Slice 19A** + **Slice 18F** … **18A–C** — **customer access BLOCKED** — **checkout/payment BLOCKED** — **app install/import/sync BLOCKED** — **next:** **Product Owner / User** resolve the exact missing staging-field decisions
- Catalogue plan status: **Slice 13O** (**`3bf260b…`**) + **`docs/catalogue`** companions **committed** — **canonical narrative** **`project-control`** + **`mzansi-select-25-product-readiness-v1`** (**includes `## Slice 21V`**, **`## Slice 21W-B`**, **`## Slice 21X`**, **`## Slice 21Z`**, **`## Slice 21AA`**, **`## Slice 21AB`**, **`## Slice 21AC`**) + **`local-supplier-sourcing-matrix-v1`** (**includes `## Slice 21W-B`**, **`## Slice 21X`**, **`## Slice 21Y`**, **`## Slice 21Z`**, **`## Slice 21AA`**, **`## Slice 21AB`**, **`## Slice 21AC`**)
- Documentation sync status: **current for `project-control` + `docs/pilot/mzansi-select-cj-imported-supplier-staging-plan-v1.md`** after the **Slice 21AD** blocked execution pass; existing catalogue/matrix posture remains valid without readiness-status promotion in this slice; **LLD unchanged** — the blocked pass introduced **no** storefront/Admin/import/checkout/payment/customer-access contract change
...
- **Slice 21AA (completed):** **Product Owner** **INCONCLUSIVE / BLOCKED** on **South Africa** shipping-calculator proof at public desk — **`## Slice 21AA`**. **Slice 21AB (completed):** **Product Owner** **PASS WITH NOTES** — **`## Slice 21AB`**. **Slice 21AC (completed):** **Security / Compliance** **PASS WITH NOTES** — **`## Slice 21AC`**. **Next:** **Senior Full-Stack Software Architect** bounded **CJ** **3**-**SKU** **implementation**/**staging** **planning** (**docs-only**).
...
- **Next approved slice:** **Senior Full-Stack Software Architect** — **bounded** **CJ** **3**-**SKU** **imported**-**supplier** **controlled**-**pilot** **implementation**/**staging** **planning** (**docs-only**; **Product Owner** **execution** slice **still** **required**). **Slice 21AC (completed):** **Security / Compliance** **PASS WITH NOTES** — **`## Slice 21AC`** / **§15K**.
...
- **Follow-up (completed):** **Slice 21AB** **PASS WITH NOTES** — authenticated calculator capture + sanitized interpretation — **`## Slice 21AB`**. **Slice 21AC (completed):** **Security / Compliance** **PASS WITH NOTES** — **`## Slice 21AC`**. **Next:** **Senior Full-Stack Software Architect** bounded **CJ** **3**-**SKU** **implementation**/**staging** **planning** (**docs-only**).
...
- **Next approved slice (current):** **Senior Full-Stack Software Architect** — **bounded** **CJ** **3**-**SKU** **implementation**/**staging** **planning** (**docs-only**).
...
- **Accepted posture:** **CJdropshipping** may **proceed** **only** to **Senior Full-Stack Software Architect** **bounded** **implementation**/**staging** **planning** as **long**-**delivery** **imported**-**supplier** **controlled pilot** route — **not** **fast**/**local** fulfilment replacement.
...
- **Refund/cancellation wording (preserve):** “If supplier stock, shipping cost, product availability, or delivery estimate changes before fulfilment, we will contact you before proceeding. You may cancel the pilot order where fulfilment cannot continue as agreed.”
...
- **Next owner:** **Senior Full-Stack Software Architect** — **bounded** **CJ** **3**-**SKU** **implementation**/**staging** **planning** (**docs-only**; **no** **Admin**/import/sync/checkout until **Product Owner** approves execution slice).
...
- **Required wording preserved:** “Imported supplier-route item. Delivery timing varies by supplier, warehouse, product attributes, and courier method. Final delivery estimate must be confirmed before fulfilment.” / “This item is part of a controlled pilot and may have extended imported-supplier delivery timing. Delivery estimate will be confirmed before fulfilment.” / “If supplier stock, shipping cost, product availability, or delivery estimate changes before fulfilment, we will contact you before proceeding. You may cancel the pilot order where fulfilment cannot continue as agreed.”
...
- **Recommended next owner:** **Product Owner / User** — review the new plan and approve or reject any later bounded manual staging execution slice.
...
- **Canonical:** **`docs/pilot/mzansi-select-cj-imported-supplier-staging-plan-v1.md`** + **`## Slice 21AC`**.
