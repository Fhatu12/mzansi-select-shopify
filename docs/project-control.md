...
- Active slice: **Product Owner / User** — **bounded next work:** (1) **review and accept** the **Slice 21M** bounded Shopify shipping/checkout **configuration plan** (**`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §12** + **`## Slice 21M`** here) before any Admin execution; (2) close remaining **Slice 21K** basket/setup questions where still open; (3) sequence a future **bounded Shopify** shipping/checkout **execution** slice **only** after **§12** acceptance + explicit go/no-go; continue **controlled Slice 15A-style feedback-only** private preview sharing where applicable (**Slice 19B PASS** — **wider private-preview sharing** pause **lifted** from **QA/readiness** perspective only; **no** public launch, checkout/payment testing, final pricing, delivery promises, product claims, **Supplier verified**, product import, Shopify Admin edits, or customer account / wishlist / newsletter / social **service** enablement — see **`## Slice 19B`**)
...
- Documentation sync status: **current for `project-control` + pilot doc (§12 Slice 21M) + catalogue Slice 21J / 21K / 21L + LLD Slice 21I–21M pilot delivery / checkout planning notes** after **Slice 21M** tracker sync; prior **Slice 19B** sync remains valid for preview-sharing posture
...
- **Product Owner operational decisions (pilot):**
  ...
  5. **Admin / staging / checkout:** **not approved** yet; requires a **separate bounded execution slice** after **Product Owner** accepts **Slice 21M** (**pilot §12**) + **§6A**/**§6B** gates and **Product Owner** go/no-go (**Slice 21L** / **Slice 21M** do **not** configure **Shopify**).
...
- **Recommended next owner:** **Product Owner / User** — **accept Slice 21M** (**pilot §12**) then final pilot go/no-go sequencing; **DevOps** / implementation owner — **bounded Shopify** shipping/checkout **Admin configuration** only after explicit written approval (**plan:** pilot **§6A** + **§12**); then **Security / Compliance** + **QA** as named in **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md`**.
...
- **Bounded Shopify shipping/checkout planning:** short gate in **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §6A**; full DevOps plan in **§12** (**Slice 21M**) — **do not configure** until **Product Owner** accepts **§12** and a separate approved **execution** slice; required future checks and **§6B** customer-access blockers are **canonical** in the pilot doc.
...
- **Canonical detail:** **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md`** (**§1**, **§5**, **§6A**, **§6B**, **§12**).
- **Recommended next owner:** **Product Owner / User** — **accept** the **Slice 21M** plan (**pilot §12**) then go/no-go for a future **bounded execution** slice; **DevOps** / implementation owner — execute Admin shipping/checkout configuration **only** after that written approval.
...
- **Canonical operational plan:** **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §12** — verdict; Shopify Admin areas for a later execution slice; recommended pilot shipping-rate setup and options evaluation; interpretation of **Pilot courier delivery — R89**; checkout/payment readiness checks; rollback; QA validation (later execution only); Product Owner approvals; risks/blockers.
...
- **Recommended next owner:** **Product Owner / User** — review and **accept or revise** **§12** before any DevOps Admin execution slice is scheduled.
