...
- Active slice: **Product Owner** — accept **Slice 21CP** decorative-image validation (**PASS WITH NOTES**) and re-circulate restricted-preview materials to internal reviewers (**21CK** walkthrough); optional mobile overflow follow-up only if desired.
