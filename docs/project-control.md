...
- **Next owner:** **DevOps / Platform Engineer** — preview sync for **Slice 21CB** search when approved; **Slice 21CC** planning remains open.
...
- **Push:** **not** executed — **DevOps** selected-file preview sync is next when approved.
- **LLD:** **`docs/lld/mzansi-select-shopify-mvp-theme-v1.md`** Slice 6 note updated for material search behaviour change.
- **Next owner:** **DevOps / Platform Engineer** — push **`main-search-foundation.liquid`**, **`search.json`**, **`theme.css`** to preview theme **`151207542967`** only.
