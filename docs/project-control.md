...
- Active slice: **Product Owner / Operator** — complete interactive **`shopify store auth`** for **`dropshippoc.myshopify.com`**, then retry bounded **`controlled-pilot`** collection cleanup per **`docs/devops/slice-21al-controlled-pilot-collection-cleanup.md`**. **Slice 21AL** execution is **BLOCKED** (no stored CLI store auth on active working copy). **Collection hygiene remains an OPEN BLOCKER** until cleanup succeeds. **Slice 21AH** / **21AG** / **21AF-D** CJ draft posture unchanged. **Headline gates** unchanged — **customer access** **BLOCKED**; **checkout/payment** **BLOCKED**; **public launch** **BLOCKED**; **`Supplier verified`** **BLOCKED**; **final pricing / delivery / product claims** **BLOCKED**; **app install/import/sync** **BLOCKED**. Continue **Slice 19B** bounded private-preview posture (**`## Slice 19B`**)
- Completed slice: **Slice 21AL** — bounded **`controlled-pilot`** collection membership cleanup — **BLOCKED** — **DevOps / Platform Engineer** (**Product Owner** approved; **no** Admin mutation executed). **Reason:** no stored **`shopify store auth`** for **`dropshippoc.myshopify.com`** on Ubuntu-Dev (CLI probe: *No stored app authentication found*). **Intended method:** **`shopify store execute`** — pre-read → **`collectionRemoveProducts`** for four handles only → post-verify. **Target:** keep **3** CJ draft rows (**CJYD230000901AZ**, **CJYD211196101AZ**, **CJYD245830501AZ**); remove **`world-map-extended-mouse-pad`**, **`gizzu-usb-to-type-c-cable-2m`**, **`ugreen-4-in-1-usb-2-0-hub`**, **`acrylic-tablet-phone-stand`** from collection **only** (remain **draft**/**restricted**). **No** publish/archive/delete/reject/exposure/media/pricing/claim/checkout changes attempted. **Cleanup note:** **`docs/devops/slice-21al-controlled-pilot-collection-cleanup.md`**. **Evidence (local; not committed):** **`artifacts/devops/slice-21al-controlled-pilot-collection-cleanup/`**. **Next:** operator auth + cleanup retry, then **QA / Test Engineer** collection-state validation. **LLD:** **unchanged**.
- Completed slice: **Slice 21AK** — controlled-pilot collection hygiene planning — **PASS WITH NOTES** (**Product Manager**; **docs-only**). **Decision:** **`controlled-pilot`** should contain only the three staged **CJ** draft rows. **Execution:** deferred to **Slice 21AL** (**BLOCKED** on auth — see above). **Plan:** **`docs/pilot/slice-21ak-controlled-pilot-collection-hygiene-plan.md`**. **LLD:** **unchanged**.
- Completed slice: **Slice 21AH** — post-staging **Security / Compliance** review of the **CJ** **3**-**SKU** imported-supplier **draft** posture — **PASS WITH NOTES** (**docs-only**). **Reviewed posture:** the three accepted **CJ** rows remain safe only as **Draft** / **restricted** / **non-public** / **non-purchasable** rows; no accepted evidence implies **`Supplier verified`**, final pricing, final delivery promise, final stock claim, warranty approval, public launch, customer access, or new customer/order/payment-data exposure. **Collection hygiene remains an OPEN BLOCKER:** existing **`controlled-pilot`** collection also contains four older unrelated draft products — **`world-map-extended-mouse-pad`**, **`gizzu-usb-to-type-c-cable-2m`**, **`ugreen-4-in-1-usb-2-0-hub`**, **`acrylic-tablet-phone-stand`** — and must be resolved before any **public** collection exposure, **customer-access** go/no-go, or **`controlled-pilot`** collection preview validation. **Still blocked:** customer access; public collection preview; checkout/payment; app install/import/sync; **`Supplier verified`**; final pricing/delivery/stock/warranty/product-claim/public-launch approvals. **Review note:** **`docs/security/slice-21ah-cj-draft-security-posture-review.md`**. **Next:** **Product Manager / Product Owner** collection-hygiene resolution before any next pilot step. **LLD:** **unchanged** — docs-only security posture review; no app/install/import/storefront/checkout/payment/customer-access behaviour change.
...
- Active owner: **Security / Compliance Engineer** — **Slice 21AH** post-staging review of **CJ** **3**-**SKU** imported-supplier **draft** posture (**docs-only** unless a separate execution slice is approved); **customer access remains BLOCKED**. **DevOps / Platform Engineer** — **Slice 21AF-D** staging is **PASS**; **no** further **Admin** widening without a separate approved slice. **Product Manager** — may advise on collection hygiene / controlled-pilot sequencing; **does not** unblock **Slice 21AH**. **Product Owner / User** — retain go/no-go authority on any later customer-access or launch gate.
- Next owner: **Security / Compliance Engineer** — **Slice 21AH**. **Product Owner / User** — retain authority on any later customer-access or launch gate. **Do not** commit **`zadropshipping/`** or **`artifacts/`**.
- Last accepted slice: **Slice 21AG** — **CJ** **3**-**SKU** staged draft **Shopify** row **QA** **validation** — **PASS WITH NOTES** (**Product Owner**; **docs-only**). **Prior:** **Slice 21AF-D** (**PASS** — bounded manual staging); **Slice 21AF-C** (**PASS WITH NOTES**, docs-only completion); **Slice 21AF-B** (**BLOCKED** — **blocked commit** **`d47b71bf2274f646f9e784ce7b53ab11866c3d9f`**); **Slice 21AF** (**BLOCKED** before **Admin** change); **Slice 21AD** (**BLOCKED** execution + **PASS WITH NOTES** planning); **Slice 21AE**; **Slice 21AC**; **Slice 21AB**; **Slice 21AA**; **Slice 21Z**; **Slice 21Y**; **Slice 21X**; **Slice 21W-B**; **Slice 21V**; **Slice 21U**; **Slice 21T**; **Slice 21S** — **`3d1511b`**; **Slice 21R**; **Slice 21Q-B3**; **Slice 21O**; **Slice 21N** — **`417e78f5ec37ab8d9e450a8fd7d9aab9c10025fd`**; **Slice 21M** / **21L** / **21K** / **21J**; **Slice 19B PASS** and earlier tracker chain unchanged.
...
- Last tracker update: **Slice 21AK** — controlled-pilot collection hygiene planning — **PASS WITH NOTES** (**Product Manager**; **docs-only**). **Decision:** **`controlled-pilot`** should contain only the three staged **CJ** draft rows; the four older unrelated draft products should be removed from that collection in a later bounded Shopify Admin cleanup pass while staying **draft**/**restricted**. **No Admin cleanup has happened yet.** **Still blocked:** customer access, checkout/payment, public launch, **`Supplier verified`**, final pricing, delivery promise, product claims, media/image decision, and collection-preview validation. **Plan:** **`docs/pilot/slice-21ak-controlled-pilot-collection-hygiene-plan.md`**. **Next:** **Product Owner**.
- Tracker status: **Slice 21AK PASS WITH NOTES** + **Slice 21AH PASS WITH NOTES** + **Slice 21AG PASS WITH NOTES** + **Slice 21AF-D PASS** + **Slice 21AF-C PASS WITH NOTES** + **Slice 21AF-B BLOCKED** + **Slice 21AF BLOCKED** + **Slice 21AE PASS WITH NOTES** + **Slice 21AD BLOCKED** (execution) + **Slice 21AD PASS WITH NOTES** (planning artifact) + **Slice 21AC PASS WITH NOTES** + **Slice 21AB PASS WITH NOTES** + **Slice 21AA INCONCLUSIVE / BLOCKED** (**ZA** shipping calculator at public desk) + **Slice 21Z PASS WITH NOTES** + **Slice 21Y PASS WITH NOTES** + **Slice 21X PASS WITH NOTES** + **Slice 21W-B INCONCLUSIVE / BLOCKED** + **Slice 21V PASS WITH NOTES / CONDITIONAL** + **Slice 21U PASS WITH NOTES** + **Slice 21T PASS WITH NOTES** + **Slice 21S PASS WITH NOTES** + **Slice 21R PASS WITH NOTES** + **Slice 21Q-B3 PASS WITH NOTES** + **Slice 21Q-B1** + **Slice 21P** + **Slice 21O PASS WITH NOTES** + **Slice 21N PASS WITH NOTES** + **Slice 21M** + **Slice 21L** + **Slice 21K** + **Slice 21J PASS WITH NOTES** + **Slice 19B PASS** + **Slice 19A** + **Slice 18F** … **18A–C** — **customer access BLOCKED** — **checkout/payment BLOCKED** — **app install/import/sync BLOCKED** — **next:** **Product Owner** review of **Slice 21AK** collection-hygiene plan
...
- Documentation sync status: **current for `project-control` + `docs/security/slice-21ah-cj-draft-security-posture-review.md` + `docs/pilot/slice-21ak-controlled-pilot-collection-hygiene-plan.md` + `docs/pilot/mzansi-select-cj-imported-supplier-staging-plan-v1.md` + `docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`** (**v1.1**) after **Slice 21AK** **PASS WITH NOTES**; **LLD unchanged** — **Slice 21AK** is a **docs-only** collection-membership planning decision (**no** storefront/Admin/import/checkout/payment/customer-access contract change)
...
- **New blocker (post-21AG):** **collection hygiene** **must** be resolved before any **public** collection exposure, **customer-access** go/no-go, or **`controlled-pilot`** collection **preview** validation.
...
- **Collection hygiene:** remains an **OPEN BLOCKER** — **`controlled-pilot`** also contains four older unrelated draft products (**`world-map-extended-mouse-pad`**, **`gizzu-usb-to-type-c-cable-2m`**, **`ugreen-4-in-1-usb-2-0-hub`**, **`acrylic-tablet-phone-stand`**) and must be resolved before any **public** collection exposure, **customer-access** go/no-go, or **`controlled-pilot`** collection preview validation.
- **Still blocked:** customer access; public collection preview; checkout/payment; app install/import/sync; **`Supplier verified`**; final pricing/delivery/stock/warranty/product-claim/public-launch approvals.
- **Review note:** **`docs/security/slice-21ah-cj-draft-security-posture-review.md`**.
- **Next owner:** **Product Manager / Product Owner** — resolve collection hygiene before any next pilot step.
...
- **Execution status:** **Slice 21AL** attempted — **BLOCKED** (no CLI store auth); see **`docs/devops/slice-21al-controlled-pilot-collection-cleanup.md`**.
- **Still blocked:** collection hygiene (Admin cleanup not completed); customer access; checkout/payment; public launch; **`Supplier verified`**; final pricing; delivery promise; product claims; media/image decision; collection-preview validation.
- **Plan:** **`docs/pilot/slice-21ak-controlled-pilot-collection-hygiene-plan.md`**.
- **Next owner:** **Product Owner / Operator** (interactive auth) → **DevOps** retry or **QA** after cleanup.
...
## Slice 21AL controlled-pilot collection cleanup (DevOps BLOCKED; auth required)

- **Decision:** **Slice 21AL** is **BLOCKED** on execution — **Product Owner** approved cleanup scope; **no** Admin mutation performed.
- **Blocker:** no stored **`shopify store auth`** for **`dropshippoc.myshopify.com`** on active working copy.
- **Human-only action:** interactive **`shopify store auth --store dropshippoc.myshopify.com --scopes read_products,write_products`** + MFA, then retry bounded **`collectionRemoveProducts`** workflow in **`docs/devops/slice-21al-controlled-pilot-collection-cleanup.md`**.
- **Target post-state:** **`controlled-pilot`** = **3** CJ draft rows only; **4** older Gadgetgyz-era drafts removed from collection membership only.
- **QA handoff target (after successful cleanup):** validate exact membership + draft/restricted posture; confirm no checkout/payment/customer-access/public-launch change.
- **Evidence (local; not committed):** **`artifacts/devops/slice-21al-controlled-pilot-collection-cleanup/`**.
- **LLD:** **unchanged** — no cleanup executed.
