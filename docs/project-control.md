...
- Active slice: **Product Manager** or **Senior Full-Stack Software Architect** — **Slice 21O** controlled pilot **product-staging readiness plan** (**`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §14**) — lock **exact Shopify product rows/handles** for the **four final pilot SKUs** (**DP0402**, **CR106-20277**, **GCPU2C2**, **74886**) before any **bounded Shopify Admin shipping execution**; **Product Owner / User** — maintain gates: **shipping Admin execution not approved** and **deferred** until **§14** row/handle lock + **separate PO-approved execution** slice; **pilot-only / product-specific** shipping profile **preferred**; **general-profile fallback not approved** unless **separately** justified and approved; **South Africa only**; checkout label **Pilot courier delivery — R89** **only** for **controlled pilot checkout testing** when later approved; **R89** **conditional** on supplier re-check before customer access; **payment/capture** **blocked** pending separate checks; **no** manual card/payment data handling; **customer access BLOCKED** until approved Admin setup + **QA pass** + final **PO** go/no-go; **refund/cancellation** per pilot **§1** remains accepted; continue **controlled Slice 15A-style feedback-only** private preview where applicable (**Slice 19B PASS** — **no** public launch, final pricing, **Supplier verified**, product import/Admin edits, checkout/payment enablement — **`## Slice 19B`**)
...
- Completed slice: **Slice 21N** — Shopify pilot shipping **configuration execution-readiness** — **PASS WITH NOTES** — **Product Owner accepted** — accepted docs commit **`417e78f5ec37ab8d9e450a8fd7d9aab9c10025fd`** (`docs: record pilot shipping execution readiness`); **CONDITIONAL GO** for future bounded Admin shipping **only after** exact pilot **Shopify** rows/handles locked (**§14 Slice 21O**); **four SKUs** final (**DP0402**, **CR106-20277**, **GCPU2C2**, **74886**); **pilot-only/product-specific** profile **preferred**; **general-profile fallback not approved** unless separate approval; **South Africa only**; **Pilot courier delivery — R89** label **only** for controlled pilot checkout testing; **R89** conditional on supplier re-check; **payment/capture** blocked pending separate checks; **no** manual card data; **customer access BLOCKED**; **refund/cancellation** per pilot **§1**; **no** Admin shipping in **21N** — see **`## Slice 21N`**, **`docs/pilot/...` §13**
...
- Next owner: **Product Manager** or **Senior Full-Stack Software Architect** — **Slice 21O** (**pilot §14**) product-staging readiness plan and **Shopify** row/handle matrix; **Product Owner / User** — approve **separate bounded execution** slices when **§14** + gates ready; **DevOps** — Admin shipping **only** after explicit PO execution approval + **§12.H** / **§6B**; **do not** commit **`zadropshipping/`** or **`artifacts/`**
- Last accepted slice: **Slice 21N** pilot shipping **execution-readiness** — **PASS WITH NOTES** — **PO accepted** — commit **`417e78f5ec37ab8d9e450a8fd7d9aab9c10025fd`**; **Slice 21O** (**§14**) **opened** for product-staging readiness planning (**no** Admin approval from planning text); **CONDITIONAL GO** for future Admin shipping per **§13** after **§14** row lock; **prior:** **Slice 21M** bounded shipping/checkout **configuration plan** — **planning recorded** (DevOps; **no** Admin); **prior:** **Slice 21L** controlled pilot **delivery wording** + **delivery-fee posture** — **PASS WITH NOTES** — **PO accepted** (docs only; **no** checkout/shipping configuration; **no** customer access); **prior:** **Slice 21K** partial **Gadgetgyz** shipping evidence — **PASS WITH NOTES** — **PO/User accepted** (supplier-checkout signal only; **no** final delivery promise; **no** execution approvals); **prior:** **Slice 21J** controlled pilot **operational decisions** — **PASS WITH NOTES** — **PO accepted** (tracker sync; **no** execution approvals); **prior:** **Slice 19B** targeted manual QA review for **Slice 19A** notes — accepted **PASS** (**PO accepted**; evidence **`artifacts/qa/slice-19b-targeted-manual-review-slice-19a-notes/20260511-013042/`**); **Slice 19A** follow-up notes **cleared**; **wider private-preview sharing** pause **lifted** from **QA/readiness** perspective; **controlled Slice 15A-style feedback-only** sharing **may continue**; **prior:** **Slice 19A** consolidated authenticated private-preview readiness sweep — accepted **PASS WITH NOTES** (**PO accepted** bounded consolidated preview validation; evidence **`artifacts/qa/slice-19a-consolidated-authenticated-private-preview-readiness-sweep/20260511-003337/`**); **prior:** **Slice 18F** authenticated preview account / wishlist / social deferred-state QA — accepted **PASS WITH NOTES** (**PO accepted** bounded deferral/chrome validation only; evidence **`artifacts/qa/slice-18f-authenticated-preview-account-wishlist-social-deferred-state/20260510-202711/`**); **the Slice 18D / 18E / 18F account-wishlist-social deferred-state chain is closed as accepted**; **prior:** **Slice 18E** storefront account / wishlist / social deferral — accepted **PASS WITH NOTES** (**PO accepted** bounded deferral semantics + **bounded selected-file CLI push** to preview **`151207542967`**; **live** untouched); **prior:** **Slice 18D** account, wishlist, and social exposure decision — accepted **PASS WITH NOTES** (**approved private-preview posture:** no active account/login/register/orders entry points; honest deferred account surfaces; wishlist/favourites visible for rhythm only, all disabled/deferred; **no** persistence, customer APIs, localStorage, saved-state capture; social icons non-link deferred placeholders only; **no** live social/external URLs until ownership, brand approval, destination safety, label clarity confirmed; approved copy palette recorded under **`## Slice 18D`**); **prior:** **Slice 18C** authenticated preview regression for footer newsletter disabled/deferred state — accepted **PASS WITH NOTES** (**desktop footer copy/semantics PASS; mobile footer copy/semantics PASS; disabled input/button PASS; submission/capture path PASS WITH NOTES; external email-service connection PASS; visual/layout preservation PASS; evidence `artifacts/qa/slice-18c-authenticated-preview-footer-newsletter-disabled-state/20260510-184531/`**); **prior last accepted slice:** **Slice 18B** Newsletter disabled/deferred copy and interaction state — **PASS WITH NOTES**; **prior:** **Slice 18A** Newsletter compliance and handling decision — **PASS WITH NOTES** — **the Slice 18A / 18B / 18C newsletter-disabled chain is now closed as accepted**; earlier: **Slice 17L** authenticated preview **`/search` card CTA** honesty accepted **PASS** (**evidence: `artifacts/qa/slice-17l-authenticated-preview-search-card-cta-honesty-20260510-143839/`**) — **closes 17J / 17K / 17L** chain — acceptance **bounded** to preview CTA honesty only; **Slice 17I PASS WITH NOTES**; **Slice 17K FAIL** remediated (**`artifacts/qa/slice-17k-authenticated-preview-search-body-honesty/20260510-154857/`**); **Slice 17F PASS WITH NOTES**; **Slice 17A** under **`Slice 16B`** evidence label; **Slice 16D PASS WITH NOTES**
...
- Last tracker update: 2026-05-12 **Slice 21N** formal **Product Owner** acceptance — **PASS WITH NOTES**; accepted commit **`417e78f5ec37ab8d9e450a8fd7d9aab9c10025fd`**; **CONDITIONAL GO** for future bounded Admin shipping **only after** **§14** locks pilot **Shopify** rows/handles; **four SKUs** locked as staging-planning set; **pilot-only/product-specific** profile **preferred**; **general-profile fallback not approved** unless separate approval; **South Africa only**; **Pilot courier delivery — R89** **only** for controlled pilot checkout testing; **R89** supplier re-check before access; **payment/capture** blocked pending separate checks; **no** manual card data; **customer access BLOCKED**; **refund/cancellation** per **§1**; **Slice 21O** (**§14**) **opened** — product-staging readiness plan (**planning only**); **Shopify** shipping Admin **execution not approved** / **deferred**; prior **Slice 21M** **§12**; prior **Slice 21L** / **21K** / **21J**; prior **2026-05-11 Slice 19B PASS** + **Product Owner acceptance** — targeted manual QA review for **Slice 19A** notes; evidence **`artifacts/qa/slice-19b-targeted-manual-review-slice-19a-notes/20260511-013042/`** — **clears** **Slice 19A** follow-up notes — **wider private-preview sharing** pause **lifted** from **QA/readiness** only — **controlled Slice 15A-style feedback-only** sharing **may continue** — **no** public launch / checkout-payment testing / final pricing / delivery promises / product claims / **Supplier verified** / product import / Shopify Admin edits / service enablement approvals; prior **Slice 19A PASS WITH NOTES** evidence **`artifacts/qa/slice-19a-consolidated-authenticated-private-preview-readiness-sweep/20260511-003337/`**; prior **Slice 18F PASS WITH NOTES** evidence **`artifacts/qa/slice-18f-authenticated-preview-account-wishlist-social-deferred-state/20260510-202711/`**
- Tracker status: **Slice 21O** (**planning opened**; **§14** product-staging readiness; **no** Admin) + **Slice 21N PASS WITH NOTES** (PO acceptance commit **`417e78f…`**; **CONDITIONAL GO**; **§13**; **no** shipping Admin in **21N**) + **Slice 21M** (**planning recorded**; **§12**; **Shopify** shipping/checkout **unconfigured**; **customer access BLOCKED**) + **Slice 21L PASS WITH NOTES** (delivery wording + fee posture) + **Slice 21K PASS WITH NOTES** (**partial** supplier-checkout signal) + **Slice 21J PASS WITH NOTES** (controlled pilot planning **`f962755…`** + **operational decisions** recorded) + **Slice 19B PASS** (clears **Slice 19A** notes; sharing pause **lifted** QA/readiness-only) + **Slice 19A PASS WITH NOTES** (consolidated preview readiness) + **Slice 18F PASS WITH NOTES** + **Slice 18E PASS WITH NOTES** + **preview theme updated (bounded push)** + **Slice 18D PASS WITH NOTES** + **Slices 18A–18C PASS WITH NOTES** (newsletter chain closed) — storefront **`/search`** honesty posture intact — account/wishlist/social deferral QA chain **closed as accepted**
...
- Documentation sync status: **current for `project-control` + pilot doc (§12–§14 Slices 21M–21O) + catalogue Slice 21J / 21K / 21L + LLD Slice 21I–21M** after **Slice 21N** acceptance + **Slice 21O** open; prior **Slice 19B** sync remains valid for preview-sharing posture
...
- **Product Owner operational decisions (pilot):**
  ...
  5. **Admin / staging / checkout:** **not approved** yet; **Shopify Admin shipping execution** **deferred** until **pilot §14** locks exact pilot **Shopify** product rows/handles; requires **separate bounded execution slice** after **Product Owner** accepts **Slice 21M** (**§12**), **Slice 21N** (**§13**) conditions, **§14** completion, **§6A**/**§6B** gates, and **Product Owner** go/no-go (**Slice 21L** / **21M** / **21N** / **21O** planning do **not** configure **Shopify**).
...
- **Recommended next owner:** **Product Manager** or **Senior Full-Stack Software Architect** — **Slice 21O** (**pilot §14**) product-staging readiness; **Product Owner / User** — execution approvals; **DevOps** — **bounded Shopify** shipping/checkout **Admin configuration** only after **§14** row lock + explicit written approval (**plan:** pilot **§6A** + **§12** + **§13** + **§14**); then **Security / Compliance** + **QA** as named in **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md`**.
...
- **Bounded Shopify shipping/checkout planning:** short gate in **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §6A**; full DevOps plan in **§12** (**Slice 21M**); **execution-readiness (accepted)** in **§13** (**Slice 21N**); **product-staging readiness (opened)** in **§14** (**Slice 21O**) — **do not configure** shipping until **§14** locks pilot **Shopify** rows/handles and **Product Owner** approves a separate **execution** slice; **§13.9** + **§12.H** + **§6B** remain **canonical**.
...
- **Canonical detail:** **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md`** (**§1**, **§5**, **§6A**, **§6B**, **§12**, **§13**, **§14**).
- **Recommended next owner:** **Product Owner / User** — pilot go/no-go and bounded **execution**-slice approvals when **§14** + gates ready; **Product Manager** or **Senior Full-Stack Software Architect** — lead **Slice 21O** (**§14**) product-staging readiness documentation.
...
- **Canonical operational plan:** **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §12** — verdict; Shopify Admin areas for a later execution slice; recommended pilot shipping-rate setup and options evaluation; interpretation of **Pilot courier delivery — R89**; checkout/payment readiness checks; rollback; QA validation (later execution only); Product Owner approvals; risks/blockers. **Execution-readiness (accepted):** **§13** (**Slice 21N**). **Product-staging readiness (opened):** **§14** (**Slice 21O**).
...
- **Recommended next owner:** **Product Owner / User** — **§12** acceptance for planning baseline; **Product Manager** or **Senior Full-Stack Software Architect** — **Slice 21O** (**§14**) before shipping Admin execution sequencing.
...
- **Posture:** **CONDITIONAL GO** for a **future** bounded **Shopify Admin shipping execution** slice **only after** exact pilot **Shopify** product rows/handles are **locked** under **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §14 (`Slice 21O`)**; **shipping Admin execution is not approved** here and **remains deferred**.
...
## Slice 21O Controlled pilot product-staging readiness plan (docs only; **planning opened**)

- **Status:** **Planning opened** — **does not** approve Shopify Admin **edit**, **import**, **staging**, **shipping**, **checkout**, **payment**, **theme push/publish**, or **customer access**.
- **Objective:** lock controlled pilot **product-staging readiness plan** and **exact Shopify product rows/handles** for the **four pilot SKUs** before any bounded **Shopify Admin shipping configuration** execution — canonical checklist **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §14**.
- **Explicit boundary:** **no** Admin action is approved by **Slice 21O** planning text alone — **only** a **later explicitly scoped execution slice** may authorize writes.
- **Recommended next owner:** **Product Manager** or **Senior Full-Stack Software Architect** — complete **§14** inputs; **Product Owner / User** — approve execution slices when ready; **DevOps** — Admin shipping **only** after **§14** lock + explicit PO approval + **§12.H** / **§6B**.
