...
- Active slice: **QA / Test Engineer** — re-run **Slice 21CT** mobile homepage overflow probe post-**Slice 21CV** on preview theme **`151207542967`** (expect **`documentElement`** **375/375**).
...
- **Next owner:** **QA / Test Engineer** — re-run **21CT** overflow probe on homepage **390×844**.
...
- **Next owner:** **QA / Test Engineer** — **21CT** overflow re-validation post-**21CV**.
