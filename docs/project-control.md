...
- Active slice: **Senior Full-Stack Software Architect** — **Slice 21CU** topbar overflow containment **re-validation FAIL** post-**21CV**; mobile homepage **`documentElement.scrollWidth`** still **640** vs **375**, **`scrollLeft`** still **~265px** despite synced **`position: absolute`** **`.topbar-track`** (see **21CT** evidence **`2026-05-21-095411`**).
