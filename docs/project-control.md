...
- Active slice: **Product Owner** — review **Slice 21AK** controlled-pilot collection-hygiene plan before any bounded Admin cleanup. **Product Manager** **Slice 21AK** verdict is **PASS WITH NOTES** (**docs-only**): **`controlled-pilot`** should contain only the three staged **CJ** draft rows, and the four older unrelated draft rows should later be removed from that collection while remaining **draft**/**restricted**. **Slice 21AH** post-staging **Security / Compliance** review is **PASS WITH NOTES** (**docs-only**); **Slice 21AF-D** staging remains **PASS** and **Slice 21AG** draft-row **QA** remains **PASS WITH NOTES**. **CJdropshipping** remains **long**-**delivery** **imported**-**supplier** **controlled pilot** **route** **only** (**not** **fast**/**local** fulfilment replacement). **Headline gates** unchanged — **customer access** **BLOCKED**; **checkout/payment** **BLOCKED**; **public launch** **BLOCKED**; **`Supplier verified`** **BLOCKED**; **final pricing / delivery / product claims** **BLOCKED**; **app install/import/sync** **BLOCKED**. **Do not** treat **`Mzansi Select Controlled Pilot — Gadgetgyz`** / **R89** as launch-ready (**dormant/blocked**). Continue **Slice 19B** bounded private-preview posture (**`## Slice 19B`**)
- Completed slice: **Slice 21AK** — controlled-pilot collection hygiene planning — **PASS WITH NOTES** (**Product Manager**; **docs-only**). **Decision:** **`controlled-pilot`** should contain only the three staged **CJ** draft rows (**CJYD230000901AZ**, **CJYD211196101AZ**, **CJYD245830501AZ**). The four older unrelated draft products (**`world-map-extended-mouse-pad`**, **`gizzu-usb-to-type-c-cable-2m`**, **`ugreen-4-in-1-usb-2-0-hub`**, **`acrylic-tablet-phone-stand`**) should be removed from that collection in a later bounded Shopify Admin cleanup pass, while remaining **draft**/**restricted**; **no** archive, delete, publish, reject, or exposure decision is implied. **No Admin cleanup has happened yet.** **Still blocked:** customer access, checkout/payment, public launch, **`Supplier verified`**, final pricing, delivery promise, product claims, media/image decision, and collection-preview validation. **Plan:** **`docs/pilot/slice-21ak-controlled-pilot-collection-hygiene-plan.md`**. **Next owner:** **Product Owner**. **LLD:** **unchanged** — docs-only planning; no behaviour change.
...
- **Older unrelated rows:** **`world-map-extended-mouse-pad`**, **`gizzu-usb-to-type-c-cable-2m`**, **`ugreen-4-in-1-usb-2-0-hub`**, and **`acrylic-tablet-phone-stand`** should be removed from **`controlled-pilot`** in a later bounded Shopify Admin cleanup pass while staying **draft**/**restricted**; no archive, delete, publish, reject, or exposure decision is implied.
- **Execution status:** **no** Admin cleanup has happened yet.
- **Still blocked:** customer access; checkout/payment; public launch; **`Supplier verified`**; final pricing; delivery promise; product claims; media/image decision; collection-preview validation.
