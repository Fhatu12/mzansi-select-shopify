...
- Active slice: **Product Owner / User** — resolve **Slice 21AF** field-spec execution blockers before any bounded **Shopify Admin** retry. **Slice 21AF** is now **BLOCKED** after **DevOps / Platform Engineer** stopped before any **Admin** change because the accepted field spec still leaves staging-critical mappings ambiguous under the “use only this doc” execution rule. **Missing decisions:** exact **CJ** reference storage mapping (**SKU** vs **metafield**), exact product-body payload rule beyond the global appended wording blocks, exact claim-control / blocked-claims source for execution, exact rollback/removal notes source, and exact **`controlled-pilot`** collection handling rule if the collection is absent or differs in **Admin**. **Security / Compliance** — **Slice 21AC** **PASS WITH NOTES** retained — **`## Slice 21AC`** / **pilot** **§15K**; **CJdropshipping** remains **long**-**delivery** **imported**-**supplier** **controlled pilot** **route** **only** (**not** **fast**/**local** fulfilment replacement). **Headline gates** unchanged — **customer access** **BLOCKED**; **checkout/payment** **BLOCKED**; **public launch** **BLOCKED**; **`Supplier verified`** **BLOCKED**; **final pricing / delivery / product claims** **BLOCKED**; **app install/import/sync** **BLOCKED**. **Do not** treat **`Mzansi Select Controlled Pilot — Gadgetgyz`** / **R89** as launch-ready (**dormant/blocked**). Continue **Slice 19B** bounded private-preview posture (**`## Slice 19B`**)
...
- Active owner: **Product Owner / User** — resolve the accepted **Slice 21AF** field-spec ambiguities before any later bounded **Shopify Admin** retry; **customer access remains BLOCKED**. **DevOps / Platform Engineer** — no further **Admin** action until the missing field decisions are recorded canonically. **Security / Compliance Engineer** — **Slice 21AC** **PASS WITH NOTES** retained — **`## Slice 21AC`** / **§15K**. **Product Manager** — maintain **CJ** **long**-**delivery** **imported**-**route** discipline (**not** **local**/**fast** replacement framing).
- Next owner: **Product Owner / User** — decide the missing **Slice 21AF** field mappings and whether a later bounded manual staging retry should be reopened. **DevOps / Platform Engineer** — retry only after that canonical decision set exists. **Product Manager** — support landed-cost / **FX** / claim interpretation for **draft** prices before customer access. **Do not** commit **`zadropshipping/`** or **`artifacts/`**.
- Last accepted slice: **Slice 21AE** — **CJ** **3**-**SKU** **manual** **staging** **field** **specification** — **PASS WITH NOTES** — **Product Owner** accepted — **docs-only**. **Latest execution outcome:** **Slice 21AF** — **BLOCKED** before any **Admin** change. **Prior:** **Slice 21AD** (**BLOCKED** execution + **PASS WITH NOTES** planning); **Slice 21AC**; **Slice 21AB**; **Slice 21AA**; **Slice 21Z**; **Slice 21Y**; **Slice 21X**; **Slice 21W-B**; **Slice 21V**; **Slice 21U**; **Slice 21T**; **Slice 21S** — **`3d1511b`**; **Slice 21R**; **Slice 21Q-B3**; **Slice 21O**; **Slice 21N** — **`417e78f5ec37ab8d9e450a8fd7d9aab9c10025fd`**; **Slice 21M** / **21L** / **21K** / **21J**; **Slice 19B PASS** and earlier tracker chain unchanged.
...
- Last tracker update: **Slice 21AF** — bounded manual **Shopify** staging retry for the approved **CJ** **3**-**SKU** field spec — **BLOCKED** before any **Admin** change. **Posture:** no product create/update, no publication, no media/image upload, no app install/authorization/import/sync, no checkout/payment/customer-access/public-launch change; evidence **`artifacts/devops/slice-21af-cj-manual-product-staging-retry/20260514-143635/`** remains local and uncommitted. **Next:** **Product Owner / User** to resolve the exact field-spec ambiguities before any later retry.
- Tracker status: **Slice 21AF BLOCKED** + **Slice 21AE PASS WITH NOTES** + **Slice 21AD BLOCKED** (execution) + **Slice 21AD PASS WITH NOTES** (planning artifact) + **Slice 21AC PASS WITH NOTES** + **Slice 21AB PASS WITH NOTES** + **Slice 21AA INCONCLUSIVE / BLOCKED** (**ZA** shipping calculator at public desk) + **Slice 21Z PASS WITH NOTES** + **Slice 21Y PASS WITH NOTES** + **Slice 21X PASS WITH NOTES** + **Slice 21W-B INCONCLUSIVE / BLOCKED** + **Slice 21V PASS WITH NOTES / CONDITIONAL** + **Slice 21U PASS WITH NOTES** + **Slice 21T PASS WITH NOTES** + **Slice 21S PASS WITH NOTES** + **Slice 21R PASS WITH NOTES** + **Slice 21Q-B3 PASS WITH NOTES** + **Slice 21Q-B1** + **Slice 21P** + **Slice 21O PASS WITH NOTES** + **Slice 21N PASS WITH NOTES** + **Slice 21M** + **Slice 21L** + **Slice 21K** + **Slice 21J PASS WITH NOTES** + **Slice 19B PASS** + **Slice 19A** + **Slice 18F** … **18A–C** — **customer access BLOCKED** — **checkout/payment BLOCKED** — **app install/import/sync BLOCKED** — **next:** **Product Owner / User** field-decision closure for any later **Slice 21AF** retry
- Catalogue plan status: **Slice 13O** (**`3bf260b…`**) + **`docs/catalogue`** companions **committed** — **canonical narrative** **`project-control`** + **`mzansi-select-25-product-readiness-v1`** (**includes `## Slice 21V`**, **`## Slice 21W-B`**, **`## Slice 21X`**, **`## Slice 21Z`**, **`## Slice 21AA`**, **`## Slice 21AB`**, **`## Slice 21AC`**) + **`local-supplier-sourcing-matrix-v1`** (**includes `## Slice 21W-B`**, **`## Slice 21X`**, **`## Slice 21Y`**, **`## Slice 21Z`**, **`## Slice 21AA`**, **`## Slice 21AB`**, **`## Slice 21AC`**) — **CJ** **3**-**SKU** field spec **`docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`** (**Slice 21AE**) is **pilot**/**staging** **planning** only (**no** **25**-handle readiness promotion)
- Documentation sync status: **current for `project-control` + `docs/pilot/mzansi-select-cj-imported-supplier-staging-plan-v1.md` + `docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`** after **Slice 21AE** **PASS WITH NOTES**; **LLD unchanged** — **Slice 21AE** is **docs-only** field specification (**no** storefront/Admin/import/checkout/payment/customer-access contract change)
...
- **Slice 21AA (completed):** **Product Owner** **INCONCLUSIVE / BLOCKED** on **South Africa** shipping-calculator proof at public desk — **`## Slice 21AA`**. **Slice 21AB (completed):** **Product Owner** **PASS WITH NOTES** — **`## Slice 21AB`**. **Slice 21AC (completed):** **Security / Compliance** **PASS WITH NOTES** — **`## Slice 21AC`**. **Next (current tracker):** **Slice 21AF** — **DevOps** bounded manual **Shopify** staging retry (**Product Owner** go/no-go). **Closed chain:** **Slice 21AD** planning → **Slice 21AE** field spec — **`docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`** (**`## Slice 21AE`**).
...
- **Next approved slice (current tracker):** **Slice 21AF** — **DevOps** bounded manual **Shopify** staging retry (**Product Owner** go/no-go). **Prior closed:** **Slice 21AE** field spec (**PASS WITH NOTES**); **Slice 21AD** planning (**PASS WITH NOTES**). **Slice 21AC (completed):** **Security / Compliance** **PASS WITH NOTES** — **`## Slice 21AC`** / **§15K**.
...
- **Follow-up (completed):** **Slice 21AB** **PASS WITH NOTES** — authenticated calculator capture + sanitized interpretation — **`## Slice 21AB`**. **Slice 21AC (completed):** **Security / Compliance** **PASS WITH NOTES** — **`## Slice 21AC`**. **Next (current tracker):** **Slice 21AF** — **DevOps** bounded manual **Shopify** staging retry (**Product Owner** go/no-go). **Closed chain:** **Slice 21AD** planning → **Slice 21AE** field spec — **`docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`** (**`## Slice 21AE`**).
...
- **Next approved slice (current tracker):** **Slice 21AF** — **DevOps** bounded manual **Shopify** staging retry (**Product Owner** go/no-go). **Prior closed:** **Slice 21AE** field spec (**PASS WITH NOTES**); **Slice 21AD** planning (**PASS WITH NOTES**).
...
- **Accepted posture:** **CJdropshipping** may **proceed** **only** through **bounded** **implementation**/**staging** **planning** then **Product Owner** field lock then **DevOps** execution (**long**-**delivery** **imported**-**supplier** **controlled pilot** route — **not** **fast**/**local** fulfilment replacement). **Completed:** **Slice 21AD** (plan) + **Slice 21AE** (field spec **`docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`**); **next** **Slice 21AF** (manual staging retry).
...
- **Next owner (superseded by tracker):** **Slice 21AD** / **21AE** / **21AF** chain — **current** **next** is **DevOps** for **Slice 21AF** after **Product Owner** go/no-go; exact fields **`docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`** (**`## Slice 21AE`**).
...
- **Recommended next owner (superseded):** **Product Owner** plan review — **Slice 21AE** closed exact field values. **Current next:** **Product Owner** go/no-go on **Slice 21AF**; then **DevOps** bounded manual staging retry per **`docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`**.
...
- **Canonical:** **`docs/pilot/mzansi-select-cj-imported-supplier-staging-plan-v1.md`** + **`## Slice 21AC`** + **`docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`** (**`## Slice 21AE`**).
...
- **Created:** **`docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`** — exact handles, titles, variant colours (**Blue** / **Coffee Bear** / **Gun Gray**), product types, **draft** staging prices (**R249** / **R279** / **R699**), collection **`controlled-pilot`**, tags, required description blocks (imported route + controlled pilot + refund/cancellation/support), **draft/restricted-only** posture, **no** media for **21AF**, **CJ** image references **blocked** pending separate **PO** decision, pricing recheck posture, **reserve** **CJYD213778501AZ**, **rejected/deferred** **CJYD197888501AZ** / **CJJJJTCF09109-White**.
- **Next approved slice:** **Slice 21AF** — **DevOps** bounded manual **Shopify** staging retry (**Product Owner** go/no-go **required**).
- **LLD:** **unchanged** — **docs-only** field specification.
- **Canonical:** **`docs/pilot/mzansi-select-cj-3-sku-staging-field-spec-v1.md`** + **`docs/pilot/mzansi-select-cj-imported-supplier-staging-plan-v1.md`** + **`## Slice 21AD`** + **`## Slice 21AC`**.
