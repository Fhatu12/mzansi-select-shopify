...
- Active slice: **Slice 17D** — promo/nav copy honesty review and handoff (**docs-only this pass**)
- Next implementation slice: **Slice 17D** — approved preview-copy implementation after Product Owner sign-off
...
- Next owner: **Product Owner** for **Slice 17D** copy approval, sequencing, and implementation handoff
...
- Last tracker update: 2026-05-10 **docs-only review** — **Slice 17D** promo/nav copy honesty review completed; risky preview-only wording is now classified, safer replacement copy is recorded, and implementation remains pending Product Owner sign-off
- Tracker status: **Slice 17D** docs-only review completed — **Slice 14B / 14C / 14D**, **Slice 17B**, **Slice 17C**, and PDP preview-only safety remain intact; implementation is still required for risky promo/nav/trust/footer/cart copy before wider private preview, and **Slices 17E / 17G** still govern newsletter and account-service decisions
...
- Documentation sync status: **current for `project-control`** after **Slice 17D** docs-only review and handoff
- LLD status: **updated in Slice 17D** for durable preview-copy honesty rules and minimal-diff copy handoff guidance

## Current active pass

**Docs-only review + handoff (this pass):** **Slice 17D** — review promo, nav, category, trust, footer, preview-product, and cart wording against the preview-only storefront posture; classify safe vs risky phrases; record preview-safe replacement copy; and leave all theme/code/service implementation for a later approved slice.
...
- **Defer with related slices:** newsletter handler / consent wording stays with **Slice 17E**; account-facing service exposure stays with **Slice 17G**; live DOM verification remains **Slice 17H**.
