...
- Active slice: **Product Owner** — **Slice 21BU** restricted-preview application walkthrough acceptance and **PDF export** decision remain open; **Slice 21BY** **EPROLO** manual **8**-SKU shortlist is recorded (**docs-only**). **EPROLO** remains **additional candidate only** — **CJdropshipping** **first**, **DSers** **second**; **no** SKU is **strong candidate** without authenticated **South Africa** calculator proof; top desk picks **BY-03** / **BY-04** / **BY-01** are **candidate** / **watch** only (**`docs/suppliers/slice-21by-eprolo-manual-sku-shortlist.md`**). **Slice 21BQ** route-honesty remains **PASS WITH NOTES** pending preview-side rendered confirmation where needed. **Headline gates** unchanged — **customer access** **BLOCKED**; **checkout/payment** **BLOCKED**; **public launch** **BLOCKED**; **customer account flows** **BLOCKED**; **`Supplier verified`** **BLOCKED**; **final pricing / delivery / product claims** **BLOCKED**; **product import/sync** **BLOCKED**; **app install** **BLOCKED**. Do **not** move to cart/checkout or purchase-flow enablement yet.
