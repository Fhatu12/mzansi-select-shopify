...
- Active slice: **Product Owner** — **Slice 21BU** restricted-preview application walkthrough acceptance and **PDF export** decision remain open; **Slice 21BX** **EPROLO** supplier-route assessment is now recorded (**docs-only**). **EPROLO** is **not** approved to replace **CJdropshipping** / **DSers**; recommended path is **manual 5–10 SKU desk review without app install** (**`docs/suppliers/slice-21bx-eprolo-supplier-route-assessment.md`**). **Slice 21BQ** bounded browse/link specificity and route-honesty implementation remains **PASS WITH NOTES** pending preview-side rendered confirmation where not already covered by accepted evidence. The project remains re-centred around **`mzansi-select-theme.html`** and **`mzansi-select-mobile.html`**. **Headline gates** unchanged — **customer access** **BLOCKED**; **checkout/payment** **BLOCKED**; **public launch** **BLOCKED**; **customer account flows** **BLOCKED**; **`Supplier verified`** **BLOCKED**; **final pricing / delivery / product claims** **BLOCKED**; **product import/sync** **BLOCKED**; **app install** **BLOCKED**. Do **not** move to cart/checkout or purchase-flow enablement yet.
- Completed slice: **Slice 21BX** — **EPROLO** supplier-route assessment — **PASS WITH NOTES** — **Product Owner** (**docs-only**; **no** Shopify Admin mutation, app install, import/sync, account changes beyond read-only desk review, product visibility/publication change, checkout/payment, publish, preview-theme push, or media enablement). **Verdict:** **test manually** as an **additional** international candidate; **do not** replace **CJdropshipping** (**first**) or **DSers** (**second**) per **Slice 21X**; **South Africa** product-level shipping proof **unverified**; **app install** remains **BLOCKED** until manual shortlist + **Security / Compliance** permission review if later requested. **Assessment:** **`docs/suppliers/slice-21bx-eprolo-supplier-route-assessment.md`**. **LLD:** **unchanged**.
