...
- **Next approved gate:** **Slice 21AB** — **CJdropshipping** **authenticated** shipping-calculator proof for **6** shortlisted candidates, **without** Shopify app **install** (**CJ** **login** **only** for calculator evidence — **no** **Shopify** app **install**, **no** **Shopify authorization**, **no** import/sync, **no** **Admin** edits, **no** staging; headline gates unchanged). **Slice 21AA (completed):** **INCONCLUSIVE / BLOCKED** on **South Africa** shipping-calculator proof at public desk — **`## Slice 21AA`**.
...
- **LLD:** **unchanged** unless a direct contradiction is found — **Slice 21X** / **21Y** / **21Z** / **21AA** / **21AB** framing is supplier strategy/docs only.
- **Canonical detail:** **`docs/catalogue/local-supplier-sourcing-matrix-v1.md` `## Slice 21X`** + **`## Slice 21Y`** + **`## Slice 21Z`** + **`## Slice 21AA`** + **`docs/project-control.md` `## Slice 21X`** + **`## Slice 21Y`** + **`## Slice 21Z`** + **`## Slice 21AA`** + **`## Slice 21AB`** + **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §15G** + **§15H** + **§15I**.
...
- **Next approved slice:** **Slice 21AB** — **CJdropshipping** **authenticated** shipping-calculator proof for **6** shortlisted candidates, **without** Shopify app **install** (**CJ** **login** **only** for calculator evidence).
...
- **Next approved slice:** **Slice 21AB** — **authenticated** **CJ** shipping-calculator proof for **6** shortlisted **without** Shopify app **install**.
...
- **LLD:** **unchanged** unless a direct contradiction is found.
- **Canonical detail:** **`docs/project-control.md` `## Slice 21AA`** + **`## Slice 21AB`** + **`docs/catalogue/local-supplier-sourcing-matrix-v1.md` `## Slice 21AA`** + **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §15I**.
