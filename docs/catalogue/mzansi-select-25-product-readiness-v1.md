...
- **Approved intended Shopify handles (four pilot SKUs):** `acrylic-tablet-or-phone-stand` · `ugreen-4-in-1-usb-2-0-hub` · `gizzu-usb-to-type-c-cable-2m` · `world-map-extended-mouse-pad`
