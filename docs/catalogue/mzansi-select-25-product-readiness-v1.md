...
- **Delivery fee (planning; Slice 21K):** **Gadgetgyz** supplier-checkout observation — **Courier Door to Door Delivery — Economy**, **R89.00**; checkout-displayed **3 to 5 business days** (**supplier timing signal only**, **not** a guaranteed customer-facing promise). Basket total shown **R745.70**. Prior **R99** flat pilot delivery **assumption is no longer accepted as confirmed**; **do not** use **R99** in pilot planning unless later supplier evidence explains a different scenario; **not** a final delivery promise.
...
- **Pilot operational gates (Product Owner; tracker sync):** stock-failure/refund SLA, customer-update SLA, evidence retention/deletion (no customer/order PII in repo docs or committed artifacts; sanitized counts/statuses only in project docs), **Gadgetgyz** pilot delivery evidence (**Slice 21K** partial — **R89** signal + basket/setup questions **open**) before customer access, and **Admin/staging/checkout** deferred until that evidence + SOP controls are recorded — **canonical** in **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md`** and **`docs/project-control.md` `## Slice 21J`** / **`## Slice 21K`**.
