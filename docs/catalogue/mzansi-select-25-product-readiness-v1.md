...
- **LLD:** **unchanged** unless a direct contradiction is found — **Slice 21X** is supplier strategy/docs only.
- **Canonical detail:** **`docs/catalogue/local-supplier-sourcing-matrix-v1.md` `## Slice 21X`** + **`docs/project-control.md` `## Slice 21X`** + **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §15G**.
