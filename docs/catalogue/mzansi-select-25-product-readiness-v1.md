...
- **Next approved gate:** **Slice 21Z** — **CJdropshipping** **route-first desk proof** **without** Shopify app **install** (**desk/public documentation and sourcing signals only** — **DSers** remains **second**; **hybrid** only if both routes pass proof gates; **Gadgetgyz** **closed** **current** pilot; **Temu** benchmark-only; **no** import/sync, **no** Shopify **permission approval**, **no** staging, **no** headline commerce approvals).
...
- **LLD:** **unchanged** unless a direct contradiction is found — **Slice 21X** / **21Y** / **21Z** framing is supplier strategy/docs only.
- **Canonical detail:** **`docs/catalogue/local-supplier-sourcing-matrix-v1.md` `## Slice 21X`** + **`## Slice 21Y`** + **`docs/project-control.md` `## Slice 21X`** + **`## Slice 21Y`** + **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §15G**.
