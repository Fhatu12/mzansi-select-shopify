...
- **R89 / delivery:** Shopify pilot profile **`Mzansi Select Controlled Pilot — Gadgetgyz`** / **ZA** / **`Pilot courier delivery` ZAR 89.0** remains the configured pilot rate (**Slice 21T**). **Slice 21V** did **not** freshly validate a current **Gadgetgyz** checkout basket showing **R89**; **R89** stays **conditional** (supplier/planning signal, **not** a final delivery promise). **Same-day manual Gadgetgyz basket + delivery signal recheck** **required** before any **no-payment** checkout/shipping-rate validation window (**Slice 21W** **Product Owner** gate).
...
- **Canonical detail:** **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §15E** + **`docs/project-control.md` `## Current State`** (**Slice 21V** / **Slice 21W**).
