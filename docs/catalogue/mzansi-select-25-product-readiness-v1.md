...
- **New tracker blocker:** collection hygiene **must** be resolved before any **public** collection exposure, **customer-access** go/no-go, or **`controlled-pilot`** collection **preview** validation. **Slice 21AL** cleanup execution **BLOCKED** (no CLI store auth) — see **`docs/devops/slice-21al-controlled-pilot-collection-cleanup.md`**.
