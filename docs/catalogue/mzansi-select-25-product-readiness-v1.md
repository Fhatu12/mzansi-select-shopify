...
- **Next approved gate:** **Slice 21AA** — **CJdropshipping** **10–15** candidate matrix with **South Africa** shipping-calculator proof, **without** Shopify app **install** (**desk/matrix only** — **no** **Admin**, **no** import/sync, **no** permission/**authorization**, **no** staging, headline gates unchanged).
...
- **LLD:** **unchanged** unless a direct contradiction is found — **Slice 21X** / **21Y** / **21Z** / **21AA** framing is supplier strategy/docs only.
- **Canonical detail:** **`docs/catalogue/local-supplier-sourcing-matrix-v1.md` `## Slice 21X`** + **`## Slice 21Y`** + **`## Slice 21Z`** + **`docs/project-control.md` `## Slice 21X`** + **`## Slice 21Y`** + **`## Slice 21Z`** + **`docs/pilot/mzansi-select-controlled-live-pilot-v1.md` §15G** + **§15H**.
