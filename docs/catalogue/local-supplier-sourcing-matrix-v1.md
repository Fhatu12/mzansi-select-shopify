...
- **Slice 21X (PASS WITH NOTES):** **CJdropshipping** + **DSers** **replacement-route stack** for **new** **10–15** candidate international sourcing (**not** broad import) — **`## Slice 21X`**. **Slice 21Y (PASS WITH NOTES):** **Security / Compliance** — **CJ** **route-first desk proof** **without** app install **may proceed**; **app install/import/sync** **remains BLOCKED** — **`## Slice 21Y`**. **Slice 21Z (PASS WITH NOTES):** **Product Owner** — **CJ** desk proof **feasible enough** to continue; **CJ** **not** **ZA** launch proven; **do not** move to **DSers** yet — **`## Slice 21Z`**. **Next:** **Slice 21AA** — matrix + **ZA** shipping-calculator proof **without** install. **Temu** **benchmark-only** — **not** a supplier route. This **does not** remove the **local-first** posture for **South African** route proof in **`## Slice 20A`** / **`## Primary recommended suppliers`** — **21X** adds an **approved international replacement layer** alongside existing matrix rows.
...
- **Slice 21Z (completed):** **Product Owner** **PASS WITH NOTES** — **CJ** desk proof **without** install — **continue** **CJ** candidates; **not** **ZA** launch proven; **next** **Slice 21AA** — **`## Slice 21Z`**.
...
- **`CJdropshipping` / `DSers` (Slice 21X + 21Y + 21Z):** **approved** **replacement-route stack** — **`CJdropshipping`** **first**, **`DSers`** **second**, **hybrid** conditional; **Slice 21Z** **Product Owner** **PASS WITH NOTES** — **continue** **CJ** candidate proof (**not** **ZA** launch proven); **Shopify** **app install**/**import**/**sync**/**authorization** **remain BLOCKED** until **`## Slice 21Y`** controls + explicit install slice — **next** **Slice 21AA** — **`docs/project-control.md` `## Slice 21X`**, **`## Slice 21Y`**, **`## Slice 21Z`**.
