...
- **Strict confirmations, matrix (15 reviewed), six continue + SKUs, rejected/deferred batch, delivery honesty, pricing/margin gap, 21AB completion + 21AC next:** **`docs/project-control.md` `## Slice 21AA`** + **`## Slice 21AB`** + **`## Slice 21AC`** (canonical detail).
...
- **`CJdropshipping` / `DSers` (Slice 21X + 21Y + 21Z + 21AA + 21AB):** **approved** **replacement-route stack** — **`CJdropshipping`** **first**, **`DSers`** **second**, **hybrid** conditional; **Slice 21Z** **Product Owner** **PASS WITH NOTES**; **Slice 21AA** **INCONCLUSIVE / BLOCKED** on public **ZA** calculator; **Slice 21AB** **PASS WITH NOTES** — **sanitized** **ZA** shipping signals + **3**-**SKU** **Security / Compliance** forward path — **CJ** **long**-**delivery** **imported** **controlled pilot** **only**; **next** **Slice 21AC**; **Shopify** **app install**/**import**/**sync**/**authorization** **remain BLOCKED** until **`## Slice 21Y`** controls + explicit install slice — **`docs/project-control.md` `## Slice 21X`**, **`## Slice 21Y`**, **`## Slice 21Z`**, **`## Slice 21AA`**, **`## Slice 21AB`**, **`## Slice 21AC`**.
