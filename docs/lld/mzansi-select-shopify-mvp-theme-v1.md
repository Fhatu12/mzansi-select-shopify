...
## Slice 21I, Slice 21J, Slice 21K, Slice 21L, and Slice 21M — Gadgetgyz controlled pilot planning (docs; customer access blocked)
...
- **Theme contract:** until a later approved implementation slice, storefront behaviour remains as implemented under **Slice 21E** (`controlled_pilot_trust_mode`, pilot PDP/cart/search/footer/card copy); **Slice 21J** / **21K** / **21L** / **21M** do **not** by themselves change Liquid, Admin, or checkout state.
- **Pilot-specific delivery/returns/support strings** for go-live copy are **canonical** in the pilot doc **§1** (**Slice 21L**).
- **Bounded Shopify shipping / checkout planning (theme + Admin contract for future slice):** **do not** configure **Shopify** shipping, rates, payments, or checkout from this documentation work. Short gate: **pilot §6A**; full DevOps plan: **pilot §12** (**Slice 21M**). If a future slice requires a visible pilot shipping line at checkout, the **approved** label is **Pilot courier delivery — R89** (exact; **§1**) — **R89** remains **pilot planning signal** until setup + QA confirm; **never** surface supplier **3–5 business days** as customer-facing copy. Checkout/payment/customer access stays **disabled** until **Product Owner** go/no-go and **pilot §6B** closure. Required future checks: shipping profile/rate setup **approval**; preview/test checkout; **mobile** + **desktop** checkout QA; payment readiness; delivery fee visibility; refund/cancellation path; customer support/contact path; **Product Owner** final pilot go/no-go — see **pilot §6A** and **§12**.
