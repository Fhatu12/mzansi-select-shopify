...
## Slice 21I through Slice 21P — Gadgetgyz controlled pilot planning (docs; customer access blocked)
...
- **Bounded Shopify shipping / checkout planning (theme + Admin contract for future slice):** **do not** configure **Shopify** shipping, rates, payments, or checkout from this documentation work. **Shopify Admin shipping configuration** depends on **exact pilot product rows/handles** being **verified and locked** per **pilot §15 (`Slice 21P`)** before a bounded shipping **execution** slice (readiness acceptance **§14** / **Slice 21O** remains the readiness slice; **§15** is the bounded staging execution spec). Short gate: **pilot §6A**; plan: **§12** (**Slice 21M**); readiness (accepted): **§13** (**Slice 21N**). If a future slice requires a visible pilot shipping line at checkout, the **approved** label is **Pilot courier delivery — R89** (exact; **§1**) — use **only** for **controlled pilot checkout testing** when separately approved; **R89** remains **pilot planning signal** until setup + supplier re-check + QA confirm; **never** surface supplier **3–5 business days** as customer-facing copy. Checkout/payment/customer access stays **disabled** until **Product Owner** go/no-go and **pilot §6B** closure. Required future checks: shipping profile/rate setup **approval**; preview/test checkout; **mobile** + **desktop** checkout QA; payment readiness; delivery fee visibility; refund/cancellation path; customer support/contact path; **Product Owner** final pilot go/no-go — see **pilot §6A**, **§12**, **§13**, **§14**, **§15**.
